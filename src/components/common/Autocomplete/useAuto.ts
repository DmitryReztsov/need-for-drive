...
//
// export function useAuto (resetField: string, list: string [], field: string, value: string, clickDropdown: boolean, wrapperRef: React.RefObject<HTMLDivElement>) {
